...
| `core/models/` | manifest、resolver、runtime cache、weight readiness | `core/models/service.py`, `core/models/registry.py`, `core/models/resolver.py`, `core/models/readiness.py` |
